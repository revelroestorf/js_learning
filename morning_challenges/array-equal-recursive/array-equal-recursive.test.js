...
describe('Array Equal', () => {
  ...
  it('should compare nested arrays', () => {
    chai.expect(arrayEqual([1,2,[1,2]],[1,2,[1,2]])).to.be.true;
    chai.expect(arrayEqual([1,2,[1,2],4],[1,2,[1,2],3])).to.be.false;
    chai.expect(arrayEqual([1,2,[1,2,3],3],[1,2,[1,2],3])).to.be.false;
    chai.expect(arrayEqual([1,[2],3],[1,2,3])).to.be.false;
  });
  it('should compare heavily nested arrays', () => {
    chai.expect(arrayEqual([1,2,[1,[1,[2]]]],[1,2,[1,[1,[2]]]])).to.be.true;
  })
});
